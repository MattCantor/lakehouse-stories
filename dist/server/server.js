...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-NutbchYK.js");
...
const manifest = { "2395578522a5af6a5670bb84157fad05b8069edd232b507a6c884274898f2193": {
  functionName: "getTitleArray_createServerFn_handler",
  importer: () => import("./assets/toc-SU6H5H-O.js")
}, "fec5c81ea9499f60a4f3879c20582379d0efb5e6aaeb4b04a29fa26c35904824": {
  functionName: "getChapter_createServerFn_handler",
  importer: () => import("./assets/_slug-BqR54e-B.js")
} };
...
async function loadEntries() {
  const routerEntry = await import("./assets/router-FoPlhYPP.js").then((n) => n.r);
